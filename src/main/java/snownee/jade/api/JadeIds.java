...
public interface JadeIds {
	...
	ResourceLocation CORE_TRANSLATE_MOD_NAME = JADE("mod_name.translated");
	...
	ResourceLocation DEBUG_LOOT_TABLE = JADE("loot_table");
	...
	ResourceLocation MC_SULFUR_CUBE = MC("sulfur_cube");
	...
	static ResourceLocation ACCESS(String path) {
		return new ResourceLocation("jade_access", path);
	}
