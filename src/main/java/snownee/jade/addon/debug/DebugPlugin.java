...
public class DebugPlugin implements IWailaPlugin {
	...
	public void registerClient(IWailaClientRegistration registration) {
		...
		ITextComponent debug = new TextComponentTranslation("config.jade.plugin_jade.debug");
	...
	public void register(IWailaCommonRegistration registration) {
		registration.registerBlockDataProvider(BlockLootTableProvider.INSTANCE, TileEntity.class);
