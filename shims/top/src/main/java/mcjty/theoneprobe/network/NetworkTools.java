...
/**
 * 1.12.2 backport: verbatim from The One Probe (mcjty/theoneprobe). The shim must provide
 * this class with the exact name/signatures because compiled integrations link against it.
 */
