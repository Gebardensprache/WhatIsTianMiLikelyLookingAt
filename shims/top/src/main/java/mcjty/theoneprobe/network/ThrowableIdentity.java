...
/**
 * 1.12.2 backport: same class name and public API as The One Probe's {@code ThrowableIdentity},
 * but logs through the shim's own logger instead of {@code TheOneProbe.setup.getLogger()} (which
...
public class ThrowableIdentity {
    ...
    public static void registerThrowable(Throwable e) {
        ...
        LOGGER.debug("The One Probe catched error: ", e);
    }
