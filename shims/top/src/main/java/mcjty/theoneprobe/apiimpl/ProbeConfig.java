...
/**
 * 1.12.2 backport: verbatim from The One Probe (mcjty/theoneprobe). Compiled integrations and
 * mixins (e.g. NomiLabs' {@code DefaultProbeInfoProviderMixin}) call {@code getTankMode()}/
 * {@code getRFMode()} on this class.
 */
